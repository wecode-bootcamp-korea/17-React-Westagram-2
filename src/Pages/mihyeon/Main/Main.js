            ...
            <div className="westargram_whole_container">
                <nav className="navigation_bar_container">
                    ...
                    <div className="navigation_bar_column input_search_container">
                        <input type="text" className="input_search_bar" value="" placeholder="검색" />
                            ...
                            <div className="board_container">
                                ...
                                <div className="comment_conatainer">
                                    ...
                                    <form className="comment_write_form">
                                        <textarea aria-label="댓글 달기 " className="comment_input" placeholder="댓글달기..."></textarea>
                                        <button className="comment_submit_button" type="button">게시</button>
                                    </form>
                                </div>
                            </div>
                        </article>
                        ...
                        <div className="main_right_container">
                            ...
                            <div className="recomandation_list">
                                ...
                                <div className="recomandation_individual">
                                    <img class="round_image" src="https://scontent-gmp1-1.cdninstagram.com/v/t51.2885-15/e35/c157.0.405.405a/s320x320/137098773_710842363150812_7843511372978027429_n.jpg?_nc_ht=scontent-gmp1-1.cdninstagram.com&_nc_cat=100&_nc_ohc=DFlqa4zw7e4AX9wezXR&tp=1&oh=2bca11045c2e951d70138ca03d4ed95b&oe=6014AB36" alt="recomandation" />
                                    <div>
